...
if __name__ == '__main__':
    ...
    parser.add_argument('--result_output_dir', default='./ft_fewshot_results/', type=str, help="exp result dir")
    ...
    for seed in range(5):  
       ...
       # Now we can move onto the training loop and we eval in each loop.
        ...
        for epoch in range(epochs):
            ...
            print(f'lowest loss:{current_dev_loss}, current epoch loss:{eval_loss_total}')
            if current_dev_loss >= eval_loss_total:
                current_dev_loss = eval_loss_total
